...
def run_convo():
    ...
    """, unsafe_allow_html=True)
    st.markdown(""":orange[*Query Router | Hallucination Grader | Reranker | Web search*]:gray[검색어에 따라 3 가지 pipeline으로 나뉘어 결과를 생성합니다. (1)LLM/NLP/AI->블로그 포스트 RAG (2)일반 질문->Web search RAG (3)일상 대화->일반 chatbot]""", 
                unsafe_allow_html=True 
                )
